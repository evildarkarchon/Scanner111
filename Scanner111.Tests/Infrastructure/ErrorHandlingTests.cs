...
public class ErrorHandlingTests
{
    ...
    ///     - An OperationCanceledException object is created with a test message.<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The returned ErrorHandlingResult has an action of Fail.<br />
    ///     - The log level is Information.<br />
    ///     - The result message contains the word "cancelled".
    /// </remarks>
    [Fact]
    ...
    ///     Preconditions:<br />
    ///     - An instance of DefaultErrorHandlingPolicy is initialized with a logger.<br />
    ///     - An UnauthorizedAccessException object is created with a specific error message.<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The returned ErrorHandlingResult has an action of Skip.<br />
    ///     - The log level is Warning.<br />
    ///     - The result message contains the provided exception message.
    /// </remarks>
    [Fact]
    ...
    ///     Preconditions:<br />
    ///     - An instance of DefaultErrorHandlingPolicy is initialized with a logger.<br />
    ///     - A FileNotFoundException object is created with a specific test message ("File not found").<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The returned ErrorHandlingResult has an action of Skip.<br />
    ///     - The log level is Warning.<br />
    ///     - The result message contains the text "File not found".
    /// </remarks>
    [Fact]
    ...
    ///     - The method is invoked with an `attemptNumber` that exceeds the maximum retry limit.
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The returned ErrorHandlingResult has an action of Skip.<br />
    ...
    ///     Preconditions:<br />
    ///     - An instance of DefaultErrorHandlingPolicy is initialized with a logger.<br />
    ///     - An OutOfMemoryException object is created with a test message.<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The returned ErrorHandlingResult has an action of Fail.<br />
    ///     - The log level is Critical.<br />
    ///     - The result message contains the error message of the thrown exception.<br />
    /// </remarks>
    [Fact]
    ...
    ///     - An IOException object is created to simulate a retryable failure scenario.<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The ShouldRetry method returns true for attempts less than or equal to the maximum allowed retries.<br />
    ///     - The ShouldRetry method returns false for attempts exceeding the maximum retry limit.<br />
    /// </remarks>
    [Fact]
    ...
    ///     - A test operation is defined that completes successfully and returns a predefined result.<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The operation is executed exactly once.<br />
    ///     - The result returned by ResilientExecutor matches the expected result of the operation.<br />
    /// </remarks>
    /// <returns>
    ...
    ///     - The operation intentionally fails with IOException for the first two attempts and succeeds on the third attempt.
    ///     <br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The operation completes successfully and returns the expected result.<br />
    ///     - The operation is attempted exactly 3 times (2 failures and 1 success).
    /// </remarks>
    [Fact]
    ...
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The test verifies that an InvalidOperationException is thrown after the allowed retry attempts are exhausted.
    ///     <br />
    ...
    ///     - A CancellationTokenSource is created and associated with the operation to facilitate cancellation.<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The operation is canceled and an OperationCanceledException is thrown.<br />
    ///     - The exception is correctly handled and propagated by the ResilientExecutor.
    /// </remarks>
    [Fact]
    ...
    ///     - An asynchronous operation is defined that sets a flag when executed.<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The provided operation is successfully executed.<br />
    ///     - The flag indicating operation execution is set to true.
    /// </remarks>
    ...
    ///     - A reliable operation is defined that returns a successful result.<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The operation executes successfully without throwing any CircuitBreakerOpenException.<br />
    ///     - The returned result matches the expected output of the operation.
    /// </remarks>
    [Fact]
    ...
    ///     - The operation passed to the CircuitBreaker always throws an exception.:<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions::<br />
    ///     - After 2 consecutive failures, the CircuitBreaker opens.:<br />
    ///     - Further attempts to execute operations via the CircuitBreaker result in a CircuitBreakerOpenException being
    ///     thrown.
    /// </remarks>
    [Fact]
    ...
    ///     - An IOException is initialized with a test message.<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ///     - The ShouldRetry method returns false for the given exception and attempt number.<br />
    /// </remarks>
    [Fact]
    ...
    public void DefaultErrorHandlingPolicy_ShouldRetry_HandlesDifferentAttempts(int attemptNumber, bool expectedResult)
    {
        ...
        // Assert
        shouldRetry.Should().Be(expectedResult,
            $"because attempt {attemptNumber} should {(expectedResult ? "allow" : "deny")} retry");
    }
    ...
    /// <remarks>
    ///     Preconditions:<br />
    ///     - A new instance of ErrorHandlingResult is created with specific values assigned for Action and Message.<br />
    /// </remarks>
    /// <remarks>
    ///     Postconditions:<br />
    ...
    ///     - The RetryDelay property is null.
    /// </remarks>
    [Fact]
