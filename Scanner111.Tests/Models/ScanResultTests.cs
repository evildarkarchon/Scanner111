...
public class ScanResultTests
{
    ...
    /// </summary>
    /// <remarks>
    ///     This test ensures that the properties of a newly created <see cref="ScanResult" /> object are initialized with the
    ///     expected default values:<br />
    ...
    /// <summary>
    ///     Unit test to validate that the <see cref="ScanResult.ReportText" /> property is correctly constructed when a report
    ///     is provided.
    /// </summary>
    /// <remarks>
    ...
    public void ScanResult_WithSampleLogPath_GeneratesCorrectOutputPath()
    {
        ...
        result.OutputPath.Should().Be(expectedOutput,
            "because OutputPath should append -AUTOSCAN.md to the log file base name");
    }
    ...
    /// </summary>
    /// <remarks>
    ///     This test ensures the following defaults are correctly set when a new <see cref="ScanStatistics" /> object is
    ///     created:<br />
    ...
    /// </summary>
    /// <remarks>
    ///     This test ensures that the getter and setter operations for the properties of the <see cref="ScanStatistics" />
    ///     class work correctly:<br />
    ...
    /// <summary>
    ///     Unit test to ensure that all properties of the <see cref="ScanResult" /> class function correctly when initialized
    ///     with values.
    /// </summary>
    /// <remarks>
    ...
    public void ScanResult_WithAllProperties_WorksCorrectly()
    {
        ...
        result.OutputPath.Should().Contain("crash-2024-01-11-08-19-43-AUTOSCAN.md",
            "because OutputPath is derived from LogPath");
    }
}