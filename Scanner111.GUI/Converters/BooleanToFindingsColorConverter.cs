...
public class BooleanToFindingsColorConverter : IValueConverter
{
    ...
    /// <returns>
    ///     A string representation of a color. Returns orange (#FFFF9500) if the input is true, green (#FF4CAF50) if
    ///     false, and gray (#FF666666) if the input is not a valid boolean.
    /// </returns>
