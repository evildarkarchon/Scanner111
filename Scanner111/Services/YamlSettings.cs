        ...
        if (_yamlSettingsCache == null)
            ...
            catch
            {
                ...
                if (App.ServiceProvider != null)
                    _yamlSettingsCache =
                        App.ServiceProvider.GetService(typeof(IYamlSettingsCache)) as IYamlSettingsCache;

                if (_yamlSettingsCache == null)
                    throw new InvalidOperationException(
                        "YAML cache service not registered. Ensure it's properly configured in DI and YamlSettings.Initialize has been called.");
            }
