...
public interface IUpdateService
{
    ...
    /// <param name="guiRequest">
    ///     If true, indicates the request is from the GUI and may raise exceptions instead of returning
    ///     false
    /// </param>
    ...
    ///     Thrown when there's an error checking for updates or a newer version is
    ///     available (if guiRequest=true)
    /// </exception>
