...
public class AppSettings
{
    ...
    public List<string> ClassicRecordsList { get; set; } = [];
    public List<string> GameIgnoreRecords { get; set; } = [];
    public List<string> GameIgnorePlugins { get; set; } = [];
    ...
    public List<string> FormIdDbPaths { get; set; } = [];
    ...
    public List<string> SimplifyRemoveStrings { get; set; } =
        ["Steam.dll", "nvwgf2umx.dll", "KERNELBASE.dll", "ntdll.dll"];

    public List<string> LastProcessingErrors { get; set; } = [];
