...
public class ClassicFallout4Yaml
{
    public GameInfo GameInfo { get; set; } = new();
    public GameInfo GameVrInfo { get; set; } = new();
    public Dictionary<string, string> XseHashedScripts { get; set; } = new();
    public Dictionary<string, string> XseHashedScriptsNew { get; set; } = new();
